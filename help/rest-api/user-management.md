...
- Ao criar a função de usuário para um [Serviço personalizado](https://experienceleague.adobe.com/pt-br/docs/marketo/using/product-docs/administration/additional-integrations/create-a-custom-service-for-use-with-rest-api) da API REST, selecione uma permissão de cada um destes grupos:
