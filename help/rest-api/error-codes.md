...
<table>
  ...
  <tr>
      ...
      <td>O servidor encontrou uma condição inesperada que o impediu de atender à solicitação.  No Marketo, isso pode incluir URLs de solicitação da API REST formados incorretamente.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>O número de chamadas hoje excedeu a cota da assinatura (é redefinido diariamente às 12h CST).&gt;Sua cota pode ser encontrada no menu Admin-&gt;Web Services. Você pode aumentar sua cota por meio do gerente da conta.</td>
    </tr>
    <tr>
