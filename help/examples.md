...
Os exemplos a seguir demonstram padrões comuns de script de email.

## Lista de eventos

Este exemplo usa um objeto personalizado Evento hipotético para demonstrar a classificação e a filtragem.
