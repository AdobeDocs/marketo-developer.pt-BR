...
- API Javascript {#javascriptapi}
  ...
  - [Conteúdo preditivo](javascript-api/predictive-content.md)
...
- [Perguntas frequentes sobre o SOAP](soap-faq.md)
- Webhooks {#webhooks}
...
- {hide-from-toc}[Operações MCP com suporte](mcp-server-operations.md)
- {hide-from-toc}[Licença](api-license.md)
