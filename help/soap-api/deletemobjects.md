...
feature: SOAP
description: Marketo SOAP deleteMObjects para excluir Opportunity e OpportunityPersonRole, com XML de solicitação e resposta, exemplos de código, retorno de DELETED UNCHANGED FALHA.
...
Exclui um ou mais [MObjects](marketo-objects.md) e retorna o resultado da operação (DELETED, UNCHANGED, FAILED).

## Solicitação

| Nome do campo | Obrigatório/Opcional | Descrição |
| --- | --- | --- |
| mObjectList->mObject->type | Obrigatório | Pode ser um de `Opportunity` ou `OpportunityPersonRole` |
| mObjectList->mObject->id | Obrigatório | ID do objeto a ser excluído |
