...
Depois da API do SOAP versão 2_2, você pode incluir um `leadSelector`.
...
Observação: o número limite de clientes em potencial com suporte em um `LeadKeySelector` é 100. Se o número de leads exceder 100, a API lançará uma exceção de parâmetro incorreta e retornará uma falha de SOAP.
