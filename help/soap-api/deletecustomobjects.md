...
description: chamadas de SOAP deleteCustomObjects.
...
Exclui um ou mais objetos personalizados e retorna o resultado da operação (DELETED, UNCHANGED, FAILED).
...
| customObjKeyLists->keyList->attribute | Obrigatório | O atributo é um par de chave/valor usado para identificar os objetos personalizados que você deseja excluir. Você pode especificar vários atributos em customObjKeyLists |
