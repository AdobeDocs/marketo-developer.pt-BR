...
feature: SOAP
description: Use getImportToListStatus para verificar o status de importação da lista estática do Marketo, campos obrigatórios, solicitação e resposta XML, código PHP e Java e práticas recomendadas de pesquisa.
...
| listName | Obrigatório | Nome da lista estática no Marketo para recuperar o status de importação. |
