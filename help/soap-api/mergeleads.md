...
title: mergeLeads
feature: SOAP
description: Use mergeLeads com o Marketo SOAP para mesclar registros de lead vencedores e perdedores. Inclui campos de solicitação, solicitação e resposta XML e exemplos de PHP e Java.
...
Aceita a chave de um lead vencedor e as chaves de vários leads perdidos para executar uma operação de mesclagem. Retorna a ID dos clientes potenciais e o status.

## Solicitação

| Nome do campo | Obrigatório/Opcional | Descrição |
| --- | --- | --- |
| winsLeadKeyList | Obrigatório | A chave usada para identificar o lead vencedor. Os valores possíveis são: `IDNUM`, `EMAIL`, `SFDCLEADID`, `LEADOWNEREMAIL`, `SFDCACCOUNTID`, `SFDCCONTACTID`, `SFDCLEADID`, `SFDCLEADOWNERID`, `SFDCOPPTYID` |
| lostLeadKeyLists | Obrigatório | Uma lista de chaves usadas para identificar os clientes potenciais perdidos. |
| mergeInSales | Opcional | Passado como booleano, como &quot;Verdadeiro&quot; ou &quot;Falso&quot; |
