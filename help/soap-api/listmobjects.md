...
title: listMObjects
feature: SOAP
description: Referência para a chamada de SOAP listMObjects que retorna nomes de objetos Marketo para describeMObjects, com XML de solicitação e resposta e código de amostra.
...
Esta função retorna os nomes dos objetos Marketo que podem ser usados como entrada na função [describeMObjects](./describemobject.md) para operações de descoberta de esquema.

## Solicitação

_Não há entradas para esta API_
