...
feature: SOAP
description: Saiba como usar o describeMObject no Marketo SOAP para recuperar metadados e atributos de campo para ActivityRecord, LeadRecord, Opportunity e OpportunityPersonRole.
...
Esta função retorna os metadados para Objetos Padrão e Virtuais. Ela pega o objeto Marketo como entrada e retorna os atributos de campo associados a esse objeto.

## Solicitação

| Nome do campo | Obrigatório/Opcional | Descrição |
| --- | --- | --- |
| objectName | Obrigatório | O nome do objeto para o qual você deseja obter metadados. `objectName` pode ser um de: `ActivityRecord`, `LeadRecord`, `Opportunity`, `OpportunityPersonRole` |
